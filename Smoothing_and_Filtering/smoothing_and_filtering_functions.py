...
class Remove_Outliers():
    ...
    def removeOutlier(self, df, columnName, n):
        """
        ...
        print("df sample:", str(df)[:200])  # Print a small sample
    ...
    def removeOutlier_q(self, df, columnName, n1, n2):
        """
    ...
    def removeOutlier_z(self, df, columnName, n):
        """
...
class Smoothing():
    ...
    def median_filter(self, df, columnName, filter_length):
    ...
    def moving_average(self, df, columnName, filter_length):
    ...
    def savitzky_golay(self, df, columnName, filter_length, order):
...
class TimeSeriesOOP():
    ...
    def __init__(self, current_df, column_of_interest, time_column, col_group, filter_length):
